    ...
    <>
      ...
      <div className="dash-shell">
        ...
        <div className="dash-header-right">
          {/* Mirrors "New Batch" on the Batches dashboard. Native React flow
              (ice water hash, solventless hash, nano isolate, 3rd-party inputs). */}
          <Link className="dash-new-btn" to="/components/new">
            + New Component
          </Link>
